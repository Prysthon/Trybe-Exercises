...
// R: Devido a classe "tech".

// 2. Crie uma função que adicione a classe 'tech' ao elemento `li` quando for clicado.
// 2.1. Deve existir apenas um elemento com a classe 'tech'. Como você faz isso?
function changeTech(event) {
    let techDocument = document.getElementsByClassName('tech')[0];
    techDocument.classList.remove ('tech');
...
function myPlaylist () {
    window.location.replace("https://open.spotify.com/artist/3WrFJ7ztbogyGnTHbHJFl2")
}

myWebpage.addEventListener('dblclick', myPlaylist)
